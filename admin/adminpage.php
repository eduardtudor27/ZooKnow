        ...
        <div class="row">
          <div class="col-md-12 mb-2">
            <div class="form-group">
              ...
              <input type="text" name="id" class="form-control form-control-lg form-control-a" placeholder="Keyword">
            </div>
          </div>
...
<br><br>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="title" placeholder="Animal name">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleInputPassword1">ContentStart</label>
    <input type="text" class="form-control" name="contentstart" placeholder="Content">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="exampleFormControlFile1">Adauga imagine spot</label>
...
<form action="../encryptins.php"method="post">
